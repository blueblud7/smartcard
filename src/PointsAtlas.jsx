...
const CARDS = [
  ...
  },
  {
    ...
    color: "#3a3a2d",
    sweetSpot: "Up to 250k MR — best ever offer",
  },
  {
    id: "venture-x",
  ...
  },
  {
    ...
    color: "#4a2d2d",
    sweetSpot: "Annual free night up to 35k points",
  },
  {
    id: "hilton-aspire",
    ...
    color: "#3a4a5a",
    sweetSpot: "Free weekend night + Diamond status",
  },
  {
    id: "citi-strata",
  ...
  {
    id: "alaska-summit",
    name: "Alaska Atmos Summit",
    issuer: "Bank of America",
    network: "Visa",
    annualFee: 395,
    bonus: 100000,
    bonusUnit: "Alaska miles",
    minSpend: 6500,
    spendWindow: 3,
    bonusValueUSD: 1800,
    ...
    color: "#1a3a4a",
    sweetSpot: "Companion fare + Oneworld redemptions",
  },
  {
    id: "bilt",
