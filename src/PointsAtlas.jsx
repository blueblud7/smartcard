...
const CARDS = [
  ...
  },
  {
    ...
    annualFee: 95,
    bonus: 200000,
    bonusUnit: "Bonvoy points (4 Free Night Awards)",
    minSpend: 4000,
    spendWindow: 4,
    bonusValueUSD: 1600,
    rules: ["5/24"],
    ...
    color: "#4a2d2d",
    sweetSpot: "4 Free Night Awards (up to 50k pts each) + $100 airline credit/yr",
  },
  {
    id: "hilton-aspire",
  ...
  },
  {
    ...
    spendWindow: 0,
    bonusValueUSD: 100,
    rules: ["$100 Bilt Cash on approval — use 5 txns/mo to earn points", "Obsidian ($95) & Palladium ($495) tiers also available"],
